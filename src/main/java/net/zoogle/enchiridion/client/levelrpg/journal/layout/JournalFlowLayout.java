...
public final class JournalFlowLayout {
    ...
    public JournalFlowLayout(List<BookPageElement> elements) {
        this(elements, BookPageSide.LEFT);
    }

    public JournalFlowLayout(List<BookPageElement> elements, BookPageSide pageSide) {
        this.elements = elements;
        this.pageSide = pageSide;
        this.cursorY = CONTENT_Y;
    }

    public void addText(BookTextBlock.Kind kind, String text) {
    ...
    public void addCenteredText(BookTextBlock.Kind kind, String text) {
        elements.add(JournalElementFactory.centeredTextElement(kind, text, CONTENT_X, cursorY, CONTENT_W));
        cursorY += JournalLayoutMetrics.lineHeightFor(kind);
    }

    public void addInteractiveTitle(String stableId, String text, Component tooltip, BookRegionAction action) {
    ...
    public void addPanel(String header, List<String> bodyLines, boolean emphasis, int fillColor, int borderColor) {
    ...
    public void addLedgerRow(JournalCharacterStat stat, int targetPageIndex) {
    ...
    public void addCenteredButton(String stableId, String label, Component tooltip, BookRegionAction action) {
