...
final class JournalElementFactory {
    private JournalElementFactory() {}

    static PageInteractiveTextLayout pageTextLayout(
            String stableId,
    ...
    static BookPageElement.TextElement centeredTextElement(
            BookTextBlock.Kind kind,
            String text,
            int contentX,
            int contentY,
    ...
    static BookPageElement.DecorationElement decorationElement(
            BookTextBlock.Kind kind,
            String text,
            int x,
            int y
    ...
    static BookPageElement.BoxElement boxElement(
            int x,
            int y,
            int width,
            int height,
    ...
    static BookPageElement.BoxElement emphasisBoxElement(
            int x,
            int y,
            int width,
            int height,
    ...
    static int appendMeasuredLines(
            List<BookPageElement> elements,
            BookTextBlock.Kind kind,
    ...
    static BookPageElement.InteractiveTextElement toInteractiveTextElement(PageInteractiveTextLayout layout) {
    ...
    static BookPageElement.ButtonElement buttonElement(
            String stableId,
            String label,
            int x,
            int y,
    ...
    record PageInteractiveTextLayout(
            String stableId,
