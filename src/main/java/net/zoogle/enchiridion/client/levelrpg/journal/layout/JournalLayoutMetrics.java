...
public final class JournalLayoutMetrics {
    public static final int TEXTURE_PAGE_TEXT_WIDTH = 115;
    public static final int TEXTURE_PAGE_TEXT_HEIGHT = 145;
    public static final int PAGE_BOTTOM_SAFE_BUFFER = 10;
    public static final int PAGE_CONTENT_WIDTH = TEXTURE_PAGE_TEXT_WIDTH - 3;
    public static final int PAGE_CONTENT_HEIGHT = TEXTURE_PAGE_TEXT_HEIGHT - PAGE_BOTTOM_SAFE_BUFFER;
    public static final int BREAK_SEARCH_WINDOW = 3;
    public static final int XP_BAR_SEGMENTS = 12;
    public static final int SKILL_BUTTON_WIDTH = 78;
    public static final int SKILL_BUTTON_HEIGHT = 14;
    public static final int SKILL_BUTTON_FOOTER_RESERVE = SKILL_BUTTON_HEIGHT + PageCanvasRenderer.BLOCK_SPACING;
    /**
     ...
     */
    public static float radarLevelDisplayNorm(int level) {
     ...
     */
    public static float radarMainVertexRadius(int combinedLevel) {
        float n = radarLevelDisplayNorm(combinedLevel);
        return RADAR_MAIN_BASELINE + (1.0f - RADAR_MAIN_BASELINE) * n;
    }

    public static int lineHeightFor(BookTextBlock.Kind kind) {
        return switch (kind) {
    ...
    public static int heightFor(BookTextBlock.Kind kind, int lineCount) {
        return lineCount * lineHeightFor(kind);
    }

    public static PageContentRect pageContentRect(BookPageSide pageSide) {
    ...
    public record PageContentRect(int contentX, int contentWidth) {}
}
