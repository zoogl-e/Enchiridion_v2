...
final class JournalPaginationEngine {
    private static final Logger LOGGER = LogUtils.getLogger();
    private static final boolean DEBUG_FRONT_MATTER_PAGINATION = false;

    private JournalPaginationEngine() {}

    static List<BookPage> paginateBlocksIntoPages(List<BookTextBlock> blocks) {
        return paginateBlocksIntoPages(blocks, null);
    }

    static List<BookPage> paginateBlocksIntoPages(List<BookTextBlock> blocks, String debugLabel) {
    ...
    static List<MeasuredLine> wrapStaticText(String text, int width) {
    ...
    static List<MeasuredLine> wrapBodyText(String text, int width) {
        List<MeasuredLine> lines = new ArrayList<>();
        if (text == null || text.isBlank()) {
            return lines;
        }
    ...
    record MeasuredBlock(BookTextBlock.Kind kind, List<MeasuredLine> lines) {}
    record MeasuredLine(String text, BreakPriority breakPriority) {}
