...
import net.zoogle.enchiridion.client.levelrpg.model.JournalCharacterSheet;
import net.zoogle.enchiridion.client.levelrpg.model.JournalCharacterStat;
import net.zoogle.enchiridion.client.levelrpg.model.JournalMilestoneEntry;
import net.zoogle.enchiridion.client.levelrpg.model.JournalSkillEntry;
import net.zoogle.enchiridion.client.levelrpg.model.JournalUnlockEntry;
...
public final class LevelRpgJournalSnapshotBridge {
    ...
    public static LevelRpgJournalSnapshot create(BookContext context, LevelRpgJournalSnapshot fallback) {
